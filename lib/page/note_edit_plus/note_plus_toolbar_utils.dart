...
class NotePlusToolbarUtils extends StatefulWidget {

  final NotePlusEditController controller;

  const NotePlusToolbarUtils({
    required this.controller,
    super.key
  });

  @override
  State<NotePlusToolbarUtils> createState()=>NotePlusToolbarUtilsState();
}

class NotePlusToolbarUtilsState extends State<NotePlusToolbarUtils> {
  ...
  Widget textSize() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children:[
        quillButton(label:"Toolbar:title".xtr, labelSize: 26, attribute:q.Attribute.h1),
        const SizedBox(width:20),
        quillButton(label:"Toolbar:smallTitle".xtr, labelSize: 21, attribute:q.Attribute.h2),
        const SizedBox(width:15),
        quillButton(label:"Toolbar:subTitle".xtr, labelSize: 16, attribute:q.Attribute.h3),
        const SizedBox(width:0),
        quillButton(label:"Toolbar:body".xtr, attribute:q.Attribute.header),
        const SizedBox(width:0),
        quillButton(label:"Toolbar:Monospace".xtr, labelSize: 16, attribute:const q.FontAttribute("monospace")),
      ]
    );
  }
