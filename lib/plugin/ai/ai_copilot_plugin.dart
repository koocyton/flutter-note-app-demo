...
class AiCopilotPluginController extends GetxController {
...
class AiCopilotPlugin extends GetView<AiCopilotPluginController> {

  const AiCopilotPlugin({super.key});
  ...
  @override
  AiCopilotPluginController get controller => Get.put(AiCopilotPluginController());
          ...
          text: TextSpan(
            ...
            children: <InlineSpan>[
              controller.aiChatList[index].isFload 
                ? TextSpan(text: ' ... ', style: TextStyle(color: Colors.black38))
                : TextSpan(text: ' ', style: TextStyle(color: Colors.black38)),
              TextSpan(
